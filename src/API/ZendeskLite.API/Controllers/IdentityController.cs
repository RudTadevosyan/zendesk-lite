...
using ZendeskLite.Application.DTOs.Request.Identity;
...
namespace ZendeskLite.API.Controllers
{
    ...
    public class IdentityController : ControllerBase
    {
        ...
        [HttpPost("register")]
        public async Task<IActionResult> Register([FromBody] RegisterRequestBody requestBody, CancellationToken ct)
        {
        ...
        [HttpPost("login")]
        public async Task<IActionResult> Login([FromBody] LoginRequestBody requestBody, CancellationToken ct)
        {
            var command = new LoginCommand(requestBody.Email, requestBody.Password);
        ...
        [HttpPost("refresh")]
        public async Task<IActionResult> Refresh([FromBody] RefreshRequestBody requestBody, CancellationToken ct)
        {
            var command = new RefreshCommand(requestBody.RefreshToken);
        ...
        [HttpPost("revoke")]
        public async Task<IActionResult> Revoke([FromBody] RevokeRequestBody requestBody, CancellationToken ct)
        {
            var command = new RevokeCommand(requestBody.RefreshToken);
